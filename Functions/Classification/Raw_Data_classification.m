...
%% {'Dataset','Configuration','size','Method','parameters','CV','K','Classifier'}
 CV_config_op={noisy_file, num2str(size(X,1)),feature_type(1:end-1), '--',CV_type,num2str(K),type_clf };
...
%% Get the best results of PWM8
   ...
   colnames_results={'Dataset','size','Method','parameters','CV','K','Classifier'};
