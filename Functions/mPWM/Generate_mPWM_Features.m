function [fPWM_train,fPWM_test,mPWM_structure]=Generate_mPWM_Features(M,k,m, X_train,y_train, X_test)

%% Get the statistical properties of the data
% [Data_pd,mu,sigma]=Split_Multi_classes_samples(X,y);
[Data_pd,mu,sigma]=Split_Multi_classes_samples(X_train,y_train);
