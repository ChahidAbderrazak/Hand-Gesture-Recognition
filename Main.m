...
% Data sources
root_OS='/Volumes/eman/chahida/';sep='/';% 'R:/chahida/';sep='\';%

data_Source=strcat(root_OS,'Projects-Dataset/sEMG-Rami/Extracted_gesture_data/');
path_Classification='/QuPWM_ALL_feature/';             % Destination 
%project_folder=pwd;project_folder = strsplit(project_folder,'\'); 

project_folder=path_Classification
path_Classification=char(strcat(root_OS,'Projects-Results/',char(project_folder(end)),path_Classification));
